...
$factory->define('App\Models\Event', function (Faker\Generator $faker) {
	...
	return [
		...
		'venue_info'     => $faker->text($maxNbChars = 100),
...
//Chicago
	...
	return [
		'city'     => 'Chicago',
		'state'    => 'IL',
		'zipcode'  => $faker->randomElement($array = $zipcodes),
		'lat'      => $lat,
		'lng'      => $lng,
